    ...
    <div className="flex-1 flex flex-col p-4 w-full gap-5 max-w-2xl mx-auto animate-fadeIn">
      ...
      <div className={`p-4 rounded-2xl border space-y-3 ${
        ...
        <ol className="space-y-2 text-xs opacity-90 list-decimal list-inside pl-1">
          ...
          <li className="leading-snug">
            Authorized users & admins can also sign in directly using <strong>Google Sign-In</strong> or registered credentials.
          </li>
        </ol>
      ...
      <div className={`p-4 rounded-2xl border space-y-3 ${
        ...
        <ul className="space-y-2 text-xs opacity-90 list-disc list-inside pl-1">
          <li>
            <strong>Select Tournament:</strong> Choose a pre-saved tournament from the database dropdown (automatically sorted by date in ascending order) or enter a custom tournament name.
          </li>
          <li>
            <strong>Choose Rounds:</strong> Pick between a 2-round or 4-round tournament setup.
          </li>
          <li>
            <strong>Recording Scores:</strong> Navigate hole-by-hole (1 through 18) to record total strokes and putts. Total score, relative to par (+/-), and front/back 9 totals calculate in real-time.
          </li>
        </ul>
      </div>

      {/* Section 3: Scorecards & Settings */}
      <div className={`p-4 rounded-2xl border space-y-3 ${
        isSunlight
          ? 'bg-yellow-100 border-black text-black'
          : isDark
        ...
        <div className="flex items-center gap-2 text-emerald-600 font-black text-sm uppercase tracking-wider">
          ...
          <span>3. Scorecards & App Settings</span>
        </div>
      ...
      <div className={`p-4 rounded-2xl border space-y-3 ${
        ...
        <div className="flex items-center gap-2 text-emerald-600 font-black text-sm uppercase tracking-wider">
          ...
          <span>4. Outdoor Sunlight Mode</span>
        </div>
